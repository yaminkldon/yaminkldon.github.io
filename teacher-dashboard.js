...
document.addEventListener('DOMContentLoaded', function() {
  console.log('🚀 DOM loaded, initializing iOS compatibility for Teacher Dashboard first...');
  iOSCompatibilityTeacherDashboard.init();
